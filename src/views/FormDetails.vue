    ...
    <div class="form-details">
      ...
      <div v-if="form">
        <div class="form-info">
          ...
          <p><strong>Adres:</strong> {{ form.streetName }}, {{ form.apartmentNumber }}, {{ form.city }}, {{ form.zipCode }}, {{ form.voivodeship }}</p>
          <p><strong>Wybrane zwierzę:</strong> {{ form.selectedAnimalId  }}</p>
